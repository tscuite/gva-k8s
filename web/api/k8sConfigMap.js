...
// @Router /k8sDeployments/getK8sDeploymentList [get]
 export const getConfigMap = (params) => {
     return service({
         url: "k8sDeployments/getConfigMap",
         method: 'get',
         params
     })
 }
 export const findConfigMap = (params) => {
    return service({
        url: "/k8sDeployments/findConfigMap",
        method: 'get',
        params
    })
}
 ...
 * @Router /k8sDeployments/getK8sDeploymentList [get]
 */
export const restartK8sDeployment = (params) => {
    return service({
        url: "/k8sDeployments/restartK8sDeployment",
        method: 'put',
        params
    })
}