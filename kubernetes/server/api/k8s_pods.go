...
func (kubernetesApi *KubernetesApi) CreateK8sPods(c *gin.Context) {
	var k8sPods kubernetesresponse.K8sPods
	_ = c.ShouldBindJSON(&k8sPods)
	if err := kubernetesService.CreateK8sPods(k8sPods); err != nil {
...
func (kubernetesApi *KubernetesApi) DeleteK8sPods(c *gin.Context) {
	var k8sPods kubernetesresponse.K8sPods
	_ = c.ShouldBindJSON(&k8sPods)
	if err := kubernetesService.DeleteK8sPods(k8sPods); err != nil {
...
func (kubernetesApi *KubernetesApi) DeleteK8sPodsByIds(c *gin.Context) {
	var IDS request.IdsReq
	_ = c.ShouldBindJSON(&IDS)
	if err := kubernetesService.DeleteK8sPodsByIds(IDS); err != nil {
...
func (kubernetesApi *KubernetesApi) UpdateK8sPods(c *gin.Context) {
	var k8sPods kubernetesresponse.K8sPods
	_ = c.ShouldBindJSON(&k8sPods)
	if err := kubernetesService.UpdateK8sPods(k8sPods); err != nil {
...
func (kubernetesApi *KubernetesApi) GetPodLog(c *gin.Context) {
	...
	if rek8sPods, err := kubernetesService.GetPodLog(kubeConfig, k8sPods); err != nil {
...
func (kubernetesApi *KubernetesApi) GetK8sPodsList(c *gin.Context) {
	// 指定Cluster
	kubeConfig, _ := kubernetesApi.ClusterID(c)
	...
	if err, list, total := kubernetesService.GetK8sPodsInfoList(kubeConfig, namespace); err != nil {
...
func (kubernetesApi *KubernetesApi) ExecContainer(c *gin.Context) {
	// 指定Cluster的kubeconfig
	kubeConfig, _ := kubernetesApi.ClusterID(c)
	if err := kubernetesService.ExecContainer(kubeConfig); err != nil {
