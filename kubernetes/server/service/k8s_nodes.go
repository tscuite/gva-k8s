...
//@return: err error
func (kubernetesService *KubernetesService) CreateK8sNodes(k8sNodes response.K8sNodes) (err error) {
...
//@param: k8sNodes model.K8sNodes
//@return: err error
func (kubernetesService *KubernetesService) DeleteK8sNodes(k8sNodes response.K8sNodes) (err error) {
...
//@return: err error
func (kubernetesService *KubernetesService) DeleteK8sNodesByIds(ids request.IdsReq) (err error) {
	err = global.GVA_DB.Delete(&[]response.K8sNodes{}, "id in ?", ids.Ids).Error
	return err
}
...
//@param: k8sNodes *model.K8sNodes
//@return: err error
func (kubernetesService *KubernetesService) UpdateK8sNodes(k8sNodes response.K8sNodes) (err error) {
...
func (kubernetesService *KubernetesService) GetK8sNodes(id uint) (err error, k8sNodes response.K8sNodes) {
...
func (kubernetesService *KubernetesService) GetK8sNodesInfoList(k8sConf string) (list []*response.K8sNodes, total int64, err error) {
	// 初始化k8s客户端
