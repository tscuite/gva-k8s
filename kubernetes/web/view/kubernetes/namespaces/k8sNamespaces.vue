<template>
  <div>
      ...
      <el-table-column label="操作">
        <template #default="scope">
          <el-popover placement="top" width="160" v-model="scope.row.visible">
            ...
            <el-button type="danger" icon="el-icon-delete" size="mini" default="reference">删除</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog modal:before-close="closeDialog" v-model="dialogFormVisible" title="弹窗操作">
